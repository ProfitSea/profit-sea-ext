...
const AnalysisProduct = () => {
  ...
  return (
    <div className="flex flex-col p-4">
      <div className="w-[100%] h-[200px] rounded-t-lg px-3.5 bg-[#CE0E006B] flex-col justify-start items-start gap-3.5 inline-flex">
        <div className="self-stretch h-[158px] py-[17px] flex-col justify-start items-start gap-3.5 flex">
      ...
      <div className="w-[100%] h-[200px] rounded-b-lg px-3.5 bg-[#65B500C4] flex-col justify-start items-start gap-3.5 inline-flex">
        <div className="self-stretch h-[158px] py-[17px] flex-col justify-start items-start gap-3.5 flex">
          <div className="self-stretch justify-start items-center gap-3.5 inline-flex">
            <div className="rounded-lg justify-center items-center flex">
